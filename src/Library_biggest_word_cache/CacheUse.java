...
/**
 * Created by Manager on 07.06.17.
 */
...
*/
        ...
        book1.bookText = "Мистер и миссис Дурсль проживали в доме номер четыре по Тисовой улице и всегда с гордостью заявляли, что они, слава богу, абсолютно нормальные люди.";

        Book book2 = new Book();
        book2.bookName = "_1984";
        book2.bookText = "1984 (тысяча девятьсот восемьдесят четвёртый) год по григорианскому календарю — високосный год, начинающийся в воскресенье. Это 1984 год нашей эры, 984 год 2 тысячелетия, 84 год XX века";
